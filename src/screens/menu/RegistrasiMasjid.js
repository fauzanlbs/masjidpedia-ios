    ...
    <View style={{ flex: 1 }}>
      <Container>
        <Content>
          ...
          >
            <Image
              style={{ height: 280, width: screenWidth, margin: 2 }}
              source={{
                uri:
                  "https://f0.pngfuel.com/png/1020/392/grey-and-blue-arrow-illustration-png-clip-art.png"
              }}
              resizeMode="stretch"
            />
          </TouchableOpacity>
          ...
          <View style={{ margin: 10, borderRadius: 3 }}>
            <Text style={{ fontFamily: "Bahnschrift", fontSize: 17 }}>
              Data Masjid
            </Text>
            ...
            >
              ...
              <Text style={{ color: "black", fontSize: 11, margin: 10 }}>
                AMBIL LOKASI MASJID
              </Text>
            </Button>
              ...
              <ListItem>
                ...
                <Body style={{ margin: 5 }}>
                  <Text style={{ fontSize: 11 }}>
                    Saya Telah Menyetujui Syarat dan Ketentuan dari Masjidpedia
                  </Text>
                </Body>
              </ListItem>
