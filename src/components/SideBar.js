        ...
        <Content>
          ...
          <List>
            <ListItem itemDivider>
              ...
              <Text style={{ fontFamily: "Bahnschrift", marginLeft: 20 }}>
                Beranda
              </Text>
            </ListItem>
            <ListItem
              itemDivider
              onPress={() => this.props.myNavigation.navigate("Profile")}
            >
            ...
            <ListItem
              itemDivider
              onPress={() => this.props.myNavigation.navigate("Notifikasi")}
            >
            ...
            <ListItem
              itemDivider
              onPress={() =>
                this.props.myNavigation.navigate("RegistrasiMasjid")
              }
            >
            ...
            <ListItem
              itemDivider
              onPress={() =>
                this.props.myNavigation.navigate("RegistrasiKomunitas")
              }
            >
            ...
            <ListItem
              itemDivider
              onPress={() =>
                this.props.myNavigation.navigate("CustomerService")
              }
            >
            ...
            <ListItem
              itemDivider
              onPress={() => this.props.myNavigation.navigate("TentangKami")}
            >
              <Icon
            ...
            <ListItem
              itemDivider
              onPress={() => this.props.myNavigation.navigate("Bantuan")}
            >
